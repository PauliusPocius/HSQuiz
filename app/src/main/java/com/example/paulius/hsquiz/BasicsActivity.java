...
public class BasicsActivity extends AppCompatActivity {
    ...
    private BasicsQuestionLibrary basicsQuestionLibrary = new BasicsQuestionLibrary();
    ...
    private void updateQuestion(){
        ...
        Question.setText(basicsQuestionLibrary.GetQuestion(Questionnumber));
        Choice1.setText(basicsQuestionLibrary.getChoices1(Questionnumber));
        Choice2.setText(basicsQuestionLibrary.getChoices2(Questionnumber));
        Choice3.setText(basicsQuestionLibrary.getChoices3(Questionnumber));
        Choice4.setText(basicsQuestionLibrary.getChoices4(Questionnumber));
        Photo.setImageResource(basicsQuestionLibrary.GetPhoto(Questionnumber));
        Answer = basicsQuestionLibrary.getAnwer(Questionnumber);
        Questionnumber++;
        if (Questionnumber == basicsQuestionLibrary.GetSize()) {
            ...
            if (Score < Integer.parseInt(res.getString(0))) {
                MYdb.Update("Basics", String.valueOf(Score));
            }
