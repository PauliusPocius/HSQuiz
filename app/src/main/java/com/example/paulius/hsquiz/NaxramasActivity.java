...
public class NaxramasActivity extends AppCompatActivity {

    private NaxramasQuestionLibrary naxramasQuestionLibrary = new NaxramasQuestionLibrary();
    ...
    private void updateQuestion() {
        ...
        Question.setText(naxramasQuestionLibrary.GetQuestion(Questionnumber));
        Choice1.setText(naxramasQuestionLibrary.getChoices1(Questionnumber));
        Choice2.setText(naxramasQuestionLibrary.getChoices2(Questionnumber));
        Choice3.setText(naxramasQuestionLibrary.getChoices3(Questionnumber));
        Choice4.setText(naxramasQuestionLibrary.getChoices4(Questionnumber));
        Photo.setImageResource(naxramasQuestionLibrary.GetPhoto(Questionnumber));
        Answer = naxramasQuestionLibrary.getAnwer(Questionnumber);
        Questionnumber++;
        if (Questionnumber == naxramasQuestionLibrary.GetSize()) {
            ...
            if (Score < Integer.parseInt(res.getString(0))) {
                MYdb.Update("Naxramas", String.valueOf(Score));
            }
